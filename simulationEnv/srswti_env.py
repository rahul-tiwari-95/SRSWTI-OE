...
class RLOrchestrator:
    ...
    def train(self, total_timesteps=100000):
        for i in range(total_timesteps):
            ...
            while True:
                ...
                if done:
                    self.progress_history.append(obs['research_progress'][0])
    ...
    def plot_progress(self):
        ...
        plt.title('Research Progress Over Episodes')
        plt.ylabel('Progress')
        plt.subplot(2, 1, 2)
        ...
        plt.xlabel('Episode')
        plt.tight_layout()
        plt.savefig(f'training_progress_{len(self.progress_history)}.png')
        plt.close()
